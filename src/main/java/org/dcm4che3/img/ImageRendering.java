...
import org.weasis.core.api.util.MathUtil;
...
public class ImageRendering {
	...
	public static PlanarImage getVoiLutImage(
		...
		if (datatype >= CvType.CV_8U && datatype < CvType.CV_32S) {
			LookupTableCV modalityLookup = adapter.getModalityLookup(p, p.isInverseLut());
			ImageCV imageModalityTransformed = modalityLookup == null
			 ...
			 * Interpretation (0028,0004) values of
			...
			if ((!p.isAllowWinLevelOnColorImage()
				...
				/*
				 * If photometric interpretation is not monochrome do not apply VOILUT. It is
				 * necessary for
				 * PALETTE_COLOR.
				 */
	 ...
	 * @see <a
	 *      href=
	 *      "http://dicom.nema.org/medical/dicom/current/output/chtml/part05/chapter_8.html">8.1.2
