...
public class DicomObjectUtil {
	 ...
	 * @see <a
	 *      href=
	 *      "http://dicom.nema.org/MEDICAL/DICOM/current/output/chtml/part03/sect_C.7.6.11.html">C.7.6.11
	...
	/**
	 * Extract the shutter color from ShutterPresentationColorCIELabValue or
	 ...
	 *
	 * @param pGray     A single gray unsigned value when rendered on a monochrome
	 *                  display. The units are
	 *                  specified in P-Values, from a minimum of 0x0000 (black) up
	 *                  to a maximum of 0xFFFF (white).
	 * @param rgbColour
	 * @return the color
	 */
