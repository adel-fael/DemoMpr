...
public class ImageTranscodeParam {
	...
	/**
	 * @param jpegCompressionQuality between 1 to 100 (100 is the best lossy
	 *                               quality).
	 */
	...
	/**
	 * It preserves the raw data when the pixel depth is more than 8 bit. The
	 * default value applies
	 * the W/L and is FALSE, the output image will be always a 8-bit per sample
	 * image.
	 *
