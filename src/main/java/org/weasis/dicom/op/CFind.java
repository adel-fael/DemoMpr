...
public class CFind {
	...
	public static final DicomParam IssuerOfAccessionNumberSequence = new DicomParam(Tag.IssuerOfAccessionNumberSequence);
	 ...
	 *                    specified number of
	 *                    matches.
	 * @param level       specifies retrieve level. Use by default STUDY for
	 *                    PatientRoot, StudyRoot,
