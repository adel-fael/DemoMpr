...
public class CGetForward implements AutoCloseable {
		...
		protected void store(
			...
			try {
				...
				try {
					...
					AdaptTransferSyntax syntax = new AdaptTransferSyntax(tsuid, streamSCU.selectTransferSyntax(cuid, tsuid));
	...
	/**
	 * @param forwardParams   the optional advanced parameters (proxy,
	...
	/**
	 * @param getParams       the C-GET optional advanced parameters (proxy,
	 *                        authentication, connection and
	 *                        TLS)
	 * @param forwardParams   the C-Store optional advanced parameters (proxy,
	 *                        authentication,
	 *                        connection and TLS)
	 * @param callingNode     the calling DICOM node configuration
	 * @param calledNode      the called DICOM node configuration
	...
	private static DicomState process(
		...
		try {
			forward = new CGetForward(forwardParams, callingNode, destinationNode, progress, cstoreParams);
