...
public class ModalityWorklist {
	...
	public static final DicomParam ScheduledProcedureStepStartDate = new DicomParam(sps,
			Tag.ScheduledProcedureStepStartDate);
	public static final DicomParam ScheduledProcedureStepStartTime = new DicomParam(sps,
			Tag.ScheduledProcedureStepStartTime);
	public static final DicomParam ScheduledPerformingPhysicianName = new DicomParam(sps,
			Tag.ScheduledPerformingPhysicianName);
	public static final DicomParam ScheduledProcedureStepDescription = new DicomParam(sps,
			Tag.ScheduledProcedureStepDescription);
	public static final DicomParam ScheduledProtocolCodeSequence = new DicomParam(sps, Tag.ScheduledProtocolCodeSequence);
	...
	public static final DicomParam ScheduledProcedureStepLocation = new DicomParam(sps,
	 ...
	 * @param keys        the matching and returning keys. DicomParam with no value
	 *                    is a returning key.
	 * @return The DicomSate instance which contains the DICOM response, the DICOM
	 *         status, the error
	...
	/**
	 * @param params      optional advanced parameters (proxy, authentication,
	 *                    connection and TLS)
	 * @param callingNode the calling DICOM node configuration
	 * @param calledNode  the called DICOM node configuration
	 * @param keys        the matching and returning keys. DicomParam with no value
	 ...
	 * @param callingNode the calling DICOM node configuration
	 * @param calledNode  the called DICOM node configuration
	 * @param cancelAfter cancel the query request after the receive of the
	 *                    specified number of
	 *                    matches.
	 * @param keys        the matching and returning keys. DicomParam with no value
	 *                    is a returning key.
